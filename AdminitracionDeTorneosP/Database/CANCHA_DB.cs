  ...
  public  class CANCHA_DB
    {
            ...
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Listacancha.precio = (reader.GetDecimal(4)) ;
        ...
        public void Insertar_Cancha(CANCHA Canchaa)
        {
            ...
            string query = "exec BG_Insertar_Cancha @Nombre,@TipoCancha,@Disponibilidad,@precio";
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                SqlCommand sql = new SqlCommand(query, conexion);
                ...
                sql.Parameters.AddWithValue("@precio", Canchaa.precio);
        ...
        public CANCHA buscar_cancha(int? id)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                try
                {
                    ...
                    Canchaa.precio = reader.GetDecimal(4);
        ...
        public void actualizar_Cancha(CANCHA agregarcancha)
        {
            ...
            string query = "exec BG_Editar_Cancha @NumeroCancha,@Nombre,@TipoCancha,@Disponibilidad,@precio";
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                ...
                command.Parameters.AddWithValue("@precio", agregarcancha.precio);
                try
                {
                    conexion.Open();
        ...
        public void eliminar_Cancha(int? id)
        {
            ...
            string query = "Exec BG_eliminar_Cancha @NumeroCancha";
            using (SqlConnection conexion = new SqlConnection(connectionstring))
            {
                SqlCommand command = new SqlCommand(query, conexion);
