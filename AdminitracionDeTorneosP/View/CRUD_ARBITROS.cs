...
namespace AdminitracionDeTorneosP.View
{
    public partial class refereeView : Form
    {
        ...
        public refereeView()
        {
            ...
            refereeList.Columns[9].HeaderText = "precio_alquiler";
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            if (action == 1)
            {
                if(textDPI.Text == "" || textName.Text == "" || textLastName.Text == "" || textAddress.Text == "" || textPhone.Text == "" || textNacionality.Text == "" || textBirthDate.Text == "" || textMail.Text == "" || textRole.Text == "" || txtPrecioAlquiler.Text == "")
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        refereeModel.precio_alquiler =Convert.ToDecimal(txtPrecioAlquiler.Text);
            ...
            {
                if (textName.Text == "" || textLastName.Text == "" || textAddress.Text == "" || textPhone.Text == "" || textNacionality.Text == "" || textBirthDate.Text == "" || textMail.Text == "" || textRole.Text == ""||txtPrecioAlquiler.Text=="")
                {
                    MessageBox.Show("valores en blanco", "ALERTA", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        decimal precio_alquiler = Convert.ToDecimal(txtPrecioAlquiler.Text);
                        //enviar como parametro las variables temporales al metodo para actualizar 
                        refereeDB.updateReferee(dpi, name, lastname, address, phone, nacionality, birthDate, email, role, precio_alquiler);
                        action = 1;
                        //Refrescar dats 
                        refereeList.DataSource = refereeDB.getRefereee();
                        //limpiar campos 
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            txtPrecioAlquiler.Text =Convert.ToString(udRefereeModel.precio_alquiler);
            }
