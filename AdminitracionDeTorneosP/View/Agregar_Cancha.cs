    ...
    private int? buscar_id()
            ...
            switch (opciones)
            {
                case 1:
                    ...
                    else
                    {
                        ...
                        Ingreso_Cancha.precio =Convert.ToDecimal(txtPrecio.Text);
                ...
                case 2:
                    ...
                    else
                    {
                        ...
                        canchaagregada.precio = Convert.ToDecimal(txtPrecio.Text);
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            if (dr2 == DialogResult.Yes)
            {
                ...
                txtPrecio.Text = Convert.ToString(TarjetaEditada.precio);
            }
